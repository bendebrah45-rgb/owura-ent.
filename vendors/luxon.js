var luxon = function(e) {
    ...
    var we = {},
        f = function(n) {
            ...
            return e.offsetName = function(e, t) {
                ...
                var t, n, r, i, o, a, u, s, e = new Date(e);
    ...
    var Mn = function(e) {
            ...
            return t.length = function(e) {
                ...
                for (var t, n = null, r = 0, i = [], e = e.map(function(e) {
                    ...
                    })); !(a = o()).done;) var a = a.value,
                    n = 1 === (r += "s" === a.type ? 1 : -1) ? a.time : (n && +n != +a.time && i.push(l.fromDateTimes(n, a.time)), null);
                return l.merge(i)
    ...
    var W = function(e) {
        ...
        k.now = function() {
            ...
            var g, p = (c ? (f = a, u = o, g = it((p = i).weekYear), f = D(p.weekNumber, 1, yt(p.weekYear, f = void 0 === f ? 4 : f, u = void 0 === u ? 1 : u)), u = D(p.weekday, 1, 7), g ? f ? !u && T("weekday", p.weekday) : T("week", p.weekNumber) : T("weekYear", p.weekYear)) : s ? (f = it((g = i).year), u = D(g.ordinal, 1, M(g.year)), f ? !u && T("ordinal", g.ordinal) : T("year", g.year)) : nt(i)) || rt(i);
