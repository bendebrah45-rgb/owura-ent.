/*!
 * Bootstrap Icons
 * https://www.jqueryscript.net/other/bootstrap-icon-picker.html
...
! function(e) {
    ...
    ! function() {
        ...
        function m(e, i, t) {
            return [parseFloat(e[0]) * (h.test(e[0]) ? i / 100 : 1), parseFloat(e[1]) * (h.test(e[1]) ? t / 100 : 1)]
        }

        function b(i, t) {
            return parseInt(e.css(i, t), 10) || 0
        }
        e.pos = {
                scrollbarWidth: function() {
                    if (void 0 !== i) return i;
                    var t, r, s = e("<div style='display:block;position:absolute;width:50px;height:50px;overflow:hidden;'><div style='height:100px;width:auto;'></div></div>"),
                        l = s.children()[0];
                    return e("body").append(s), t = l.offsetWidth, s.css("overflow", "scroll"), t === (r = l.offsetWidth) && (r = s[0].clientWidth), s.remove(), i = t - r
                },
                getScrollInfo: function(i) {
                    var t = i.isWindow || i.isDocument ? "" : i.element.css("overflow-x"),
                        r = i.isWindow || i.isDocument ? "" : i.element.css("overflow-y"),
                        s = "scroll" === t || "auto" === t && i.width < i.element[0].scrollWidth;
                    return {
                        width: "scroll" === r || "auto" === r && i.height < i.element[0].scrollHeight ? e.pos.scrollbarWidth() : 0,
                        height: s ? e.pos.scrollbarWidth() : 0
                    }
                },
                ...
                if (!i || !i.of) return o.apply(this, arguments);
                i = e.extend({}, i);
                var h, n, T, f, p, d, u = e(i.of),
                    g = e.pos.getWithinInfo(i.within),
                    k = e.pos.getScrollInfo(g),
                ...
                }(u), u[0].preventDefault && (i.at = "left top"), n = d.width, T = d.height, f = d.offset, p = e.extend({}, f), e.each(["my", "at"], function() {
                    var e, t, r = (i[this] || "").split(" ");
                    1 === r.length && (r = s.test(r[0]) ? r.concat(["center"]) : l.test(r[0]) ? ["center"].concat(r) : ["center", "center"]), r[0] = s.test(r[0]) ? r[0] : "center", r[1] = l.test(r[1]) ? r[1] : "center", e = a.exec(r[0]), t = a.exec(r[1]), v[this] = [e ? e[0] : 0, t ? t[0] : 0], i[this] = [c.exec(r[0])[0], c.exec(r[1])[0]]
                }), 1 === w.length && (w[1] = w[0]), "right" === i.at[0] ? p.left += n : "center" === i.at[0] && (p.left += n / 2), "bottom" === i.at[1] ? p.top += T : "center" === i.at[1] && (p.top += T / 2), h = m(v.at, n, T), p.left += h[0], p.top += h[1], this.each(function() {
                    var s, l, a = e(this),
                        c = a.outerWidth(),
                        o = a.outerHeight(),
                        d = b(this, "marginLeft"),
                        y = b(this, "marginTop"),
                        x = c + d + b(this, "marginRight") + k.width,
                        q = o + y + b(this, "marginBottom") + k.height,
                        C = e.extend({}, p),
                        V = m(v.my, a.outerWidth(), a.outerHeight());
                    "right" === i.my[0] ? C.left -= c : "center" === i.my[0] && (C.left -= c / 2), "bottom" === i.my[1] ? C.top -= o : "center" === i.my[1] && (C.top -= o / 2), C.left += V[0], C.top += V[1], s = {
                        marginLeft: d,
                        marginTop: y
                    }, e.each(["left", "top"], function(t, r) {
                        e.ui.pos[w[t]] && e.ui.pos[w[t]][r](C, {
                            targetWidth: n,
                            targetHeight: T,
                            elemWidth: c,
                            elemHeight: o,
                            ...
                            collisionWidth: x,
                            collisionHeight: q,
                            offset: [h[0] + V[0], h[1] + V[1]],
                            my: i.my,
                            at: i.at,
                            within: g,
                            elem: a
                        })
                    }), i.using && (l = function(e) {
                        var s = f.left - C.left,
                            l = s + n - c,
                            h = f.top - C.top,
                            m = h + T - o,
                            b = {
                                ...
                                horizontal: l < 0 ? "left" : s > 0 ? "right" : "center",
                                vertical: m < 0 ? "top" : h > 0 ? "bottom" : "middle"
                            };
                        n < c && r(s + l) < n && (b.horizontal = "center"), T < o && r(h + m) < T && (b.vertical = "middle"), t(r(s), r(l)) > t(r(h), r(m)) ? b.important = "horizontal" : b.important = "vertical", i.using.call(this, e, b)
                    }), a.offset(e.extend(C, {
                        using: l
                    }))
                })
            }, e.ui.pos = {
                _trigger: function(e, i, t, r) {
                    i.elem && i.elem.trigger({
                        type: t,
                        position: e,
                        positionData: i,
                        triggered: r
                ...
                fit: {
                    left: function(i, r) {
                        e.ui.pos._trigger(i, r, "posCollide", "fitLeft");
                        var s, l = r.within,
                            a = l.isWindow ? l.scrollLeft : l.offset.left,
                            c = l.width,
                            h = i.left - r.collisionPosition.marginLeft,
                            o = a - h,
                            m = h + r.collisionWidth - c - a;
                        r.collisionWidth > c ? o > 0 && m <= 0 ? (s = i.left + o + r.collisionWidth - c - a, i.left += o - s) : i.left = m > 0 && o <= 0 ? a : o > m ? a + c - r.collisionWidth : a : o > 0 ? i.left += o : m > 0 ? i.left -= m : i.left = t(i.left - h, i.left), e.ui.pos._trigger(i, r, "posCollided", "fitLeft")
                    },
                    top: function(i, r) {
                        e.ui.pos._trigger(i, r, "posCollide", "fitTop");
                        var s, l = r.within,
                            a = l.isWindow ? l.scrollTop : l.offset.top,
                            c = r.within.height,
                            h = i.top - r.collisionPosition.marginTop,
                            o = a - h,
                            m = h + r.collisionHeight - c - a;
                        r.collisionHeight > c ? o > 0 && m <= 0 ? (s = i.top + o + r.collisionHeight - c - a, i.top += o - s) : i.top = m > 0 && o <= 0 ? a : o > m ? a + c - r.collisionHeight : a : o > 0 ? i.top += o : m > 0 ? i.top -= m : i.top = t(i.top - h, i.top), e.ui.pos._trigger(i, r, "posCollided", "fitTop")
                    }
                },
                flip: {
                    left: function(i, t) {
                        e.ui.pos._trigger(i, t, "posCollide", "flipLeft");
                        var s, l, a = t.within,
                            c = a.offset.left + a.scrollLeft,
                            h = a.width,
                            o = a.isWindow ? a.scrollLeft : a.offset.left,
                            m = i.left - t.collisionPosition.marginLeft,
                            b = m - o,
                            n = m + t.collisionWidth - h - o,
                            T = "left" === t.my[0] ? -t.elemWidth : "right" === t.my[0] ? t.elemWidth : 0,
                            f = "left" === t.at[0] ? t.targetWidth : "right" === t.at[0] ? -t.targetWidth : 0,
                            p = -2 * t.offset[0];
                        b < 0 ? ((s = i.left + T + f + p + t.collisionWidth - h - c) < 0 || s < r(b)) && (i.left += T + f + p) : n > 0 && ((l = i.left - t.collisionPosition.marginLeft + T + f + p - o) > 0 || r(l) < n) && (i.left += T + f + p), e.ui.pos._trigger(i, t, "posCollided", "flipLeft")
                    },
                    top: function(i, t) {
                        e.ui.pos._trigger(i, t, "posCollide", "flipTop");
                        var s, l, a = t.within,
                            c = a.offset.top + a.scrollTop,
                            h = a.height,
                            o = a.isWindow ? a.scrollTop : a.offset.top,
                            m = i.top - t.collisionPosition.marginTop,
                            b = m - o,
                            n = m + t.collisionHeight - h - o,
                            T = "top" === t.my[1] ? -t.elemHeight : "bottom" === t.my[1] ? t.elemHeight : 0,
                            f = "top" === t.at[1] ? t.targetHeight : "bottom" === t.at[1] ? -t.targetHeight : 0,
                            p = -2 * t.offset[1];
                        b < 0 ? ((l = i.top + T + f + p + t.collisionHeight - h - c) < 0 || l < r(b)) && (i.top += T + f + p) : n > 0 && ((s = i.top - t.collisionPosition.marginTop + T + f + p - o) > 0 || r(s) < n) && (i.top += T + f + p), e.ui.pos._trigger(i, t, "posCollided", "flipTop")
                    }
                },
                flipfit: {
                    left: function() {
            ...
            function() {
                var i, t, r, s, l, a = document.getElementsByTagName("body")[0],
                    c = document.createElement("div");
                for (l in i = document.createElement(a ? "div" : "body"), r = {
                        visibility: "hidden",
                        width: 0,
                        height: 0,
                        border: 0,
                ...
                i.appendChild(c), (t = a || document.documentElement).insertBefore(i, t.firstChild), c.style.cssText = "position: absolute; left: 10.7432222px;", s = e(c).offset().left, e.support.offsetFractions = s > 10 && s < 11, i.innerHTML = "", t.removeChild(i)
            }()
    }();
    e.ui.position
}),
function(e) {
    ...
    l._idCounter = 0, l.defaultOptions = {
    ...
    }, l.batch = function(i, t) {
        var r = Array.prototype.slice.call(arguments, 2);
        return e(i).each(function() {
            var i = e(this).data("iconpicker");
            i && i[t].apply(i, r)
        })
    }, l.prototype = {
        constructor: l,
        options: {},
        _id: 0,
        _trigger: function(i, t) {
            t = t || {}, this.element.trigger(e.extend({
                type: i,
        ...
        _createPopover: function() {
            ...
            var t = this.popover.find(".popover-title");
            if (this.options.title && t.append(e('<div class="popover-title-text">' + this.options.title + "</div>")), this.hasSeparatedSearchInput() && !this.options.searchInFooter ? t.append(this.options.templates.search) : this.options.title || t.remove(), this.options.showFooter && !i(this.options.templates.footer)) {
                var r = e(this.options.templates.footer);
                this.hasSeparatedSearchInput() && this.options.searchInFooter && r.append(e(this.options.templates.search)), i(this.options.templates.buttons) || r.append(e(this.options.templates.buttons)), this.popover.append(r)
            }
            return !0 === this.options.animation && this.popover.addClass("fade show"), this.popover
        },
        _createIconpicker: function() {
            ...
            var t = function(t) {
                    var r = e(this);
                    r.is("i") && (r = r.parent()), i._trigger("iconpickerSelect", {
                        iconpickerItem: r,
                        iconpickerValue: i.iconpickerValue
                    }), !1 === i.options.mustAccept ? (i.update(r.data("iconpickerValue")), i._trigger("iconpickerSelected", {
                        iconpickerItem: this,
                        iconpickerValue: i.iconpickerValue
                    })) : i.update(r.data("iconpickerValue"), !0), i.options.hideOnSelect && !1 === i.options.mustAccept && i.hide()
                },
                r = e(this.options.templates.iconpickerItem),
                s = [];
            for (var l in this.options.icons)
                if ("string" == typeof this.options.icons[l].title) {
                    var a = r.clone();
                    if (a.find("i").addClass(this.options.fullClassFormatter(this.options.icons[l].title)), a.data("iconpickerValue", this.options.icons[l].title).on("click.iconpicker", t), a.attr("title", "." + this.options.icons[l].title), this.options.icons[l].searchTerms.length > 0) {
                        for (var c = "", h = 0; h < this.options.icons[l].searchTerms.length; h++) c = c + this.options.icons[l].searchTerms[h] + " ";
                        a.attr("data-search-terms", c)
                    }
                    s.push(a)
                }
        ...
        _isEventInsideIconpicker: function(i) {
            var t = e(i.target);
            return !((!t.hasClass("iconpicker-element") || t.hasClass("iconpicker-element") && !t.is(this.element)) && 0 === t.parents(".iconpicker-popover").length)
        },
        _bindElementEvents: function() {
            ...
            this.getSearchInput().on("keyup.iconpicker", function() {
                ...
                i.update(i.iconpickerValue), i._trigger("iconpickerSelected", {
                    iconpickerItem: e,
                    iconpickerValue: i.iconpickerValue
                }), i.isInline() || i.hide()
                ...
                i.show(), e.stopPropagation()
            }), this.hasComponent() && this.component.on("click.iconpicker", function() {
                i.toggle()
            }), this.hasInput() && this.input.on("keyup.iconpicker", function(t) {
                s(t.keyCode, [38, 40, 37, 39, 16, 17, 18, 9, 8, 91, 93, 20, 46, 186, 190, 46, 78, 188, 44, 86]) ? i._updateFormGroupStatus(!1 !== i.getValid(this.value)) : i.update(), !0 === i.options.inputSearch && i.filter(e(this).val().toLowerCase())
            })
        },
        _bindWindowEvents: function() {
            var i = e(window.document),
                t = this,
                r = ".iconpicker.inst" + this._id;
            e(window).on("resize.iconpicker" + r + " orientationchange.iconpicker" + r, function(e) {
                t.popover.hasClass("in") && t.updatePlacement()
            }), t.isInline() || i.on("mouseup" + r, function(e) {
                t._isEventInsideIconpicker(e) || t.isInline() || t.hide()
            })
        },
        ...
        updatePlacement: function(i, t) {
            i = i || this.options.placement, this.options.placement = i, t = !0 === (t = t || this.options.collision) ? "flip" : t;
            var r = {
                at: "right bottom",
                my: "right top",
                of: this.hasInput() && !this.isInputGroup() ? this.input : this.container,
                collision: !0 === t ? "flip" : t,
                within: window
            };
            if (this.popover.removeClass("inline topLeftCorner topLeft top topRight topRightCorner rightTop right rightBottom bottomRight bottomRightCorner bottom bottomLeft bottomLeftCorner leftBottom left leftTop"), "object" == typeof i) return this.popover.pos(e.extend({}, r, i));
            switch (i) {
                case "inline":
                    r = !1;
                    break;
                case "topLeftCorner":
                    r.my = "right bottom", r.at = "left top";
                    break;
                case "topLeft":
                    r.my = "left bottom", r.at = "left top";
                    break;
                case "top":
                    r.my = "center bottom", r.at = "center top";
                    break;
                case "topRight":
                    r.my = "right bottom", r.at = "right top";
                    break;
                case "topRightCorner":
                    r.my = "left bottom", r.at = "right top";
                    break;
                case "rightTop":
                    r.my = "left bottom", r.at = "right center";
                    break;
                case "right":
                    r.my = "left center", r.at = "right center";
                    break;
                case "rightBottom":
                    r.my = "left top", r.at = "right center";
                    break;
                case "bottomRightCorner":
                    r.my = "left top", r.at = "right bottom";
                    break;
                case "bottomRight":
                    r.my = "right top", r.at = "right bottom";
                    break;
                case "bottom":
                    r.my = "center top", r.at = "center bottom";
                    break;
                case "bottomLeft":
                    r.my = "left top", r.at = "left bottom";
                    break;
                case "bottomLeftCorner":
                    r.my = "right top", r.at = "left bottom";
                    break;
                case "leftBottom":
                    r.my = "right top", r.at = "left center";
                    break;
                case "left":
                    r.my = "right center", r.at = "left center";
                    break;
                case "leftTop":
                    r.my = "right bottom", r.at = "left center";
                    break;
                default:
                    return !1
            }
            ...
            }), !1 !== r ? this.popover.pos(r).css("maxWidth", e(window).width() - this.container.offset().left - 5) : this.popover.css({
                top: "auto",
                right: "auto",
                bottom: "auto",
                left: "auto",
        ...
        getValid: function(i) {
            ...
            var t = "" === i;
            i = e.trim(i);
            for (var s = !1, l = 0; l < this.options.icons.length; l++)
                if (this.options.icons[l].title === i) {
                    s = !0;
                    break
                }
            return !(!s && !t) && i
        ...
        setValue: function(e) {
            var i = this.getValid(e);
            return !1 !== i ? (this.iconpickerValue = i, this._trigger("iconpickerSetValue", {
                iconpickerValue: i
        ...
        setSourceValue: function(e) {
            return !1 !== (e = this.setValue(e)) && (this.hasInput() ? this.input.val(this.iconpickerValue) : this.element.data("iconpickerValue", this.iconpickerValue), this._trigger("iconpickerSetSourceValue", {
                iconpickerValue: e
            })), e
        },
        getSourceValue: function(e) {
            var i = e = e || this.options.defaultValue;
            return void 0 !== (i = this.hasInput() ? this.input.val() : this.element.data("iconpickerValue")) && "" !== i && null !== i && !1 !== i || (i = e), i
        },
        hasInput: function() {
            return !1 !== this.input
        },
        ...
        filter: function(t) {
            if (i(t)) return this.iconpicker.find(".iconpicker-item").show(), e(!1);
            var r = [];
            return this.iconpicker.find(".iconpicker-item").each(function() {
                var i = e(this),
                    s = i.attr("title").toLowerCase();
                s = s + " " + (i.attr("data-search-terms") ? i.attr("data-search-terms").toLowerCase() : "");
                var l = !1;
                try {
                    l = new RegExp("(^|\\W)" + t, "g")
                } catch (i) {
                    l = !1
                }!1 !== l && s.match(l) ? (r.push(i), i.show()) : i.hide()
            }), r
        },
        show: function() {
            if (this.popover.hasClass("in")) return !1;
            e.iconpicker.batch(e(".iconpicker-popover.in:not(.inline)").not(this.popover), "hide"), this._trigger("iconpickerShow", {
                iconpickerValue: this.iconpickerValue
            }), this.updatePlacement(), this.popover.addClass("in"), setTimeout(e.proxy(function() {
        ...
        hide: function() {
            ...
            this._trigger("iconpickerHide", {
                iconpickerValue: this.iconpickerValue
            }), this.popover.removeClass("in"), setTimeout(e.proxy(function() {
        ...
        update: function(e, i) {
            return e = (typeof e == 'boolean') ? this.getSourceValue(this.iconpickerValue) : e, this._trigger("iconpickerUpdate", {
                iconpickerValue: this.iconpickerValue
            }), !0 === i ? e = this.setValue(e) : (e = this.setSourceValue(e), this._updateFormGroupStatus(!1 !== e)), !1 !== e && this._updateComponents(), this._trigger("iconpickerUpdated", {
                iconpickerValue: this.iconpickerValue
            }), e
        },
        destroy: function() {
            this._trigger("iconpickerDestroy", {
                iconpickerValue: this.iconpickerValue
            }), this.element.removeData("iconpicker").removeData("iconpickerValue").removeClass("iconpicker-element"), this._unbindElementEvents(), this._unbindWindowEvents(), e(this.popover).remove(), this._trigger("iconpickerDestroyed", {
                iconpickerValue: this.iconpickerValue
            })
        },
        disable: function() {
    ...
    }, e.iconpicker = l, e.fn.iconpicker = function(i) {
        return this.each(function() {
            var t = e(this);
            t.data("iconpicker") || t.data("iconpicker", new l(this, "object" == typeof i ? i : {}))
        })
    }, l.defaultOptions = e.extend(l.defaultOptions, {
        icons: [{
            title: "bi bi-alarm",
            searchTerms: []
        }, {
